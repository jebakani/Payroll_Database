...
Insert into PayRollTable(name,startDate,gender,phoneNumber,address,department,BasicPay,Deduction,TaxablePay,tax) values('Terissa','2020-07-06','Female',9737847733,'Marketting and sale','mumbai',20000,2000,1000,200)
...
insert into Employee values('raj',1,737337795,'kknager','chennai','Tamilnadu','2017-06-15')
insert into Employee values('Arul',1,737337795,'anna nagar','maduari','Tamilnadu','2017-06-15')
insert into Employee values('joy',1,737337795,'t nagar','chennai','Tamilnadu','2017-06-15')
insert into Employee values('terissa',1,737337795,'pudhur','madurai','Tamilnadu','2017-06-15')
insert into Employee values('Jessi',3,2564635458,'pudur','salem','Tamilnadu','2016-07-29')

update Employee set phoneNumber=9684523654 where emp_name='Joy'
update Employee set phoneNumber=8564215015 where emp_name='terissa'
update Employee set phoneNumber=8694235665 where emp_name='Arul'
...
update Employee set gender='M' where emp_name='Arul' or emp_name='raj'
update Employee set gender='F' where emp_name='joy' or emp_name='Jessi' or emp_name='terissa'
...
insert into PayRoll(Emp_id,BasicPay,Deduction,TaxablePay,Tax) values((select emp_id from Employee where emp_name='raj'),20000,2000,1500,500)
